...
//            System.out.printf("Vertice %d , distancia mas corta = %d\n", i, distancia[i]);
    ...
    public void printShortestPath() {
        ...
        System.out.printf("Calculando ruta: ");
        int destino;
        destino = Principal.whereis;
        print(destino);
        System.out.printf("\n");
    }
    ...
    void print(int destino) {
        ...
        if (Principal.camino == null) {
            Principal.camino=""+destino;
        }else{
            Principal.camino=Principal.camino+"-"+destino;
        }
    }
